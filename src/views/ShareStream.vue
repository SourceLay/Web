    ...
    <div id="content">
            ...
            <div id="pop-content">
                <div id="pop-title">
                    ...
                    <div id="pop-bottomBar">
                        ...
                        <div v-if="detail.isLiked===true" @click="like(detail)" class="pop-button">
                        ...
                        <div v-else-if="detail.isLiked===false" @click="like(detail)" class="pop-button">
        ...
        <div id="stream">
            <div @click="popDetail(card)" class="fileCard" v-for="card in cards" :key="card.id">
                ...
                <h1>{{card.filename}}</h1>
                <div id="card-bottom">
                    <div v-if="card.isLiked===true" id="card-like">
                    ...
                    <div v-else-if="card.isLiked===false" id="card-like">
