<template>
    <div>
        <div class="topheader" v-bind:class="[needFixed ? 'fixTop' : 'unfixed' ,'']">
            <div id="opeartionBar">
                <div class="iconBtn">
                    <input class="file-upload-input" type="file" accept="*" @change="uploadFile"/>
            ...
            <ul>
                <li v-for="item in files" :key="item.attributes.id">
                    ...
                    <div id="fileItem" v-if="item.attributes.type==='text/directory'" @dblclick="enterFolder(item.attributes.name)">
                        ...
                        <div id="file-fileName"><div class="vertical-middle-align"><p>{{item.attributes.name}}</p></div></div>
                        <div id="opBtn">
                            <div id="downloadBtn"><svg class="icon" viewBox="0 0 1068 1024"></svg></div>
