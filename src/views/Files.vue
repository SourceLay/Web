            ...
            <ul>
                <li v-for="item in files" :key="item.id">
                    <div id="fileItem">
                        ...
                        <div id="fileSize"><p>{{formatSize(item.attributes.size)}}</p></div>
                        <div id="fileDate"><p>{{new Date(item.attributes.updated_at).toLocaleString()}}</p></div>
                    </div>
                </li>
            </ul>
            </form>
