...
export default {
  ...
  methods:{
    ...
    uploadFile: function(e){
        ...
        let folder = '/users/' + store.state.userInfo.id + this.paths[this.paths.length - 1].path;
